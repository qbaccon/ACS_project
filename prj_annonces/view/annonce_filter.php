...
echo "<div><a href='index.php?filter=adv'>Aventure</a></div>";
echo "<div><a href='index.php?filter=rpg'>RPG</a></div>";
echo "<div><a href='index.php?filter=mmorpg'>MMORPG</a></div>";
echo "<div><a href='index.php?filter=pzl'>Puzzle/Enigme</a></div>";